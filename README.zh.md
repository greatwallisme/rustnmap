...
> **致敬**: RustNmap 向 [Nmap](https://nmap.org/) 致敬 -- 作为网络扫描领域的黄金标准，Nmap 已引领该领域超过二十年。Nmap 的设计理念与实现深深启发了本项目。
...
| 靶机 | 类型 | 用途 |
|------|------|------|
| `scanme.nmap.org` (45.33.32.156) | 公网主机（Nmap 项目） | 默认对比靶机，41 项扫描类型一致性测试 |
| `153.3.238.0/24` | 公网 /24 网段 | 多目标并行、cwnd 扩展、T0-T5 时间模板 |
...
详见 [benchmarks/README.md](benchmarks/README.md) 了解完整测试套件详情、配置及运行方法。
